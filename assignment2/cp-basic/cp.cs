...
// Dafny 2.2.0.10923
// Command Line Options: cp.dfy IoNative.cs
// cp.dfy
...
lemma {:axiom} writeOnBuffer(fs: FileStream, file_offset: nat32, buffer: array?<byte>, num_bytes: int32)
  requires fs.IsOpen()
  requires fs.env.Valid()
  requires fs.env.ok.ok()
  requires fs.Name() in fs.env.files.state()
  ensures fresh(buffer)
  decreases fs, file_offset, buffer, num_bytes
...
namespace @__default {
  ...
  public partial class @__default {
    ...
    TAIL_CALL_START: ;
      ...
      var _arrayinit0 = Dafny.Helpers.Id<@Func<Dafny.Sequence<@A>,@Func<BigInteger,@A>>>((@_98_s) => (@_99_i) => (@_98_s).Select(@_99_i))(@s);
    ...
    TAIL_CALL_START: ;
      ...
      char[] @_101_sourceFile = new char[0];
      char[] _out1;
      @HostConstants.@GetCommandLineArg(1UL, out _out1);
      @_101_sourceFile = _out1;
      char[] @_102_destFile = new char[0];
      char[] _out2;
      @HostConstants.@GetCommandLineArg(2UL, out _out2);
      @_102_destFile = _out2;
      bool @_103_sourceFileExists = false;
      bool _out3;
      @FileStream.@FileExists(@_101_sourceFile, out _out3);
      @_103_sourceFileExists = _out3;
      if (!(@_103_sourceFileExists))
      {
        System.Console.Write(Dafny.Sequence<char>.FromString("Source file doesn't exist!\r\n"));
        return;
      }
      bool @_104_destFileExists = false;
      bool _out4;
      @FileStream.@FileExists(@_102_destFile, out _out4);
      @_104_destFileExists = _out4;
      if (@_104_destFileExists)
      {
        System.Console.Write(Dafny.Sequence<char>.FromString("Destination file already exists!\r\n"));
        return;
      }
      bool @_105_source = false;
      @FileStream @_106_sourceFileStream = default(@FileStream);
      bool _out5;
      @FileStream _out6;
      @FileStream.@Open(@_101_sourceFile, out _out5, out _out6);
      @_105_source = _out5;
      @_106_sourceFileStream = _out6;
      if (!(@_105_source))
      {
        System.Console.Write(Dafny.Sequence<char>.FromString("SourceFile failed to open!\r\n"));
        return;
      }
      bool @_107_destination = false;
      @FileStream @_108_destFileStream = default(@FileStream);
      bool _out7;
      @FileStream _out8;
      @FileStream.@Open(@_102_destFile, out _out7, out _out8);
      @_107_destination = _out7;
      @_108_destFileStream = _out8;
      if (!(@_107_destination))
      {
        System.Console.Write(Dafny.Sequence<char>.FromString("DestinationFile failed to open!\r\n"));
        return;
      }
      bool @_109_success = false;
      int @_110_len = 0;
      bool _out9;
      int _out10;
      @FileStream.@FileLength(@_101_sourceFile, out _out9, out _out10);
      @_109_success = _out9;
      @_110_len = _out10;
      if (!(@_109_success))
      {
      ...
      BigInteger @_111_file__offset = BigInteger.Zero;
      BigInteger _rhs0 = new BigInteger(0);
      @_111_file__offset = _rhs0;
      BigInteger @_112_num__bytes = BigInteger.Zero;
      BigInteger _rhs1 = new BigInteger(256);
      @_112_num__bytes = _rhs1;
      byte[] @_113_buffer = new byte[0];
      var _nw1 = new byte[(int)(@_112_num__bytes)];
      @_113_buffer = _nw1;
      BigInteger @_114_start = BigInteger.Zero;
      BigInteger _rhs2 = new BigInteger(0);
      @_114_start = _rhs2;
      bool @_115_readFromSource = false;
      bool @_116_writeToDest = false;
      bool _rhs4 = true;
      bool _rhs3 = _rhs4;
      bool _rhs6 = true;
      bool _rhs5 = _rhs6;
      @_115_readFromSource = _rhs3;
      @_116_writeToDest = _rhs5;
      while (((@_111_file__offset) + (@_112_num__bytes)) < (new BigInteger(@_110_len)))
      {
        { }
        bool _out11;
        (@_106_sourceFileStream).@Read((int)(@_111_file__offset), @_113_buffer, (int)(@_114_start), (int)(@_112_num__bytes), out _out11);
        @_115_readFromSource = _out11;
        if (!(@_115_readFromSource))
        {
          System.Console.Write(Dafny.Sequence<char>.FromString("Read failed!\r\n"));
          return;
        }
        bool _out12;
        (@_108_destFileStream).@Write((int)(@_111_file__offset), @_113_buffer, (int)(@_114_start), (int)(@_112_num__bytes), out _out12);
        @_116_writeToDest = _out12;
        if (!(@_116_writeToDest))
        {
          System.Console.Write(Dafny.Sequence<char>.FromString("Write failed!\r\n"));
          return;
        }
        BigInteger _rhs7 = (@_111_file__offset) + (@_112_num__bytes);
        @_111_file__offset = _rhs7;
      }

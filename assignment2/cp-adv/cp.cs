// Dafny program cp.dfy compiled into C#
...
// Dafny 2.2.0.10923
// Command Line Options: cp.dfy IoNative.cs Utils.cs
// cp.dfy
...
lemma {:axiom} writeOnBuffer(sourceFileStream: FileStream, file_offset: nat32, buffer: array?<byte>, num_bytes: int32)
  ...
  decreases sourceFileStream, file_offset, buffer, num_bytes
...
class Utils {
  static method {:extern} WantOverride() returns (wantDelete: bool)

  static method {:extern} DeleteFile(filename: array<char>)
    decreases filename
}
")]
...
namespace @__default {
  ...
  public partial class @__default {
    ...
    TAIL_CALL_START: ;
      ...
      var _arrayinit0 = Dafny.Helpers.Id<@Func<Dafny.Sequence<@A>,@Func<BigInteger,@A>>>((@_102_s) => (@_103_i) => (@_102_s).Select(@_103_i))(@s);
    ...
    TAIL_CALL_START: ;
      ...
      if ((@_104_args) != (3U))
      {
        System.Console.Write(Dafny.Sequence<char>.FromString("Invalid arguments, should be: ./cp SourceFile DestFile\r\n"));
        return;
      }
      char[] @_105_sourceFile = new char[0];
      char[] _out1;
      @HostConstants.@GetCommandLineArg(1UL, out _out1);
      @_105_sourceFile = _out1;
      bool @_106_sourceFileExists = false;
      bool _out2;
      @FileStream.@FileExists(@_105_sourceFile, out _out2);
      @_106_sourceFileExists = _out2;
      if (!(@_106_sourceFileExists))
      {
        System.Console.Write(Dafny.Sequence<char>.FromString("Source file doesn't exist!\r\n"));
        return;
      }
      char[] @_107_destFile = new char[0];
      char[] _out3;
      @HostConstants.@GetCommandLineArg(2UL, out _out3);
      @_107_destFile = _out3;
      bool @_108_destFileExists = false;
      bool _out4;
      @FileStream.@FileExists(@_107_destFile, out _out4);
      @_108_destFileExists = _out4;
      if (@_108_destFileExists)
      {
        System.Console.Write(Dafny.Sequence<char>.FromString("Destination file already exists! Do you want to overwrite it? yes/no? \r\n"));
        bool @_109_wantOverride = false;
        bool _out5;
        @Utils.@WantOverride(out _out5);
        @_109_wantOverride = _out5;
        if (!(@_109_wantOverride))
        {
          System.Console.Write(Dafny.Sequence<char>.FromString("File copy ABORTED!\r\n"));
          return;
        }
      }
      bool @_110_source = false;
      @FileStream @_111_sourceFileStream = default(@FileStream);
      bool _out6;
      @FileStream _out7;
      @FileStream.@Open(@_105_sourceFile, out _out6, out _out7);
      @_110_source = _out6;
      @_111_sourceFileStream = _out7;
      if (!(@_110_source))
      {
        System.Console.Write(Dafny.Sequence<char>.FromString("SourceFile failed to open!\r\n"));
        return;
      }
      bool @_112_destination = false;
      @FileStream @_113_destFileStream = default(@FileStream);
      bool _out8;
      @FileStream _out9;
      @FileStream.@Open(@_107_destFile, out _out8, out _out9);
      @_112_destination = _out8;
      @_113_destFileStream = _out9;
      if (!(@_112_destination))
      {
        System.Console.Write(Dafny.Sequence<char>.FromString("DestinationFile failed to open!\r\n"));
        return;
      }
      bool @_114_success = false;
      int @_115_len = 0;
      bool _out10;
      int _out11;
      @FileStream.@FileLength(@_105_sourceFile, out _out10, out _out11);
      @_114_success = _out10;
      @_115_len = _out11;
      if (!(@_114_success))
      {
        System.Console.Write(Dafny.Sequence<char>.FromString("Couldn't get file size!\r\n"));
        return;
      }
      BigInteger @_116_file__offset = BigInteger.Zero;
      BigInteger _rhs0 = new BigInteger(0);
      @_116_file__offset = _rhs0;
      BigInteger @_117_buffer__size = BigInteger.Zero;
      BigInteger _rhs1 = new BigInteger(256);
      @_117_buffer__size = _rhs1;
      byte[] @_118_buffer = new byte[0];
      var _nw1 = new byte[(int)(@_117_buffer__size)];
      @_118_buffer = _nw1;
      BigInteger @_119_start = BigInteger.Zero;
      BigInteger _rhs2 = new BigInteger(0);
      @_119_start = _rhs2;
      bool @_120_readFromSource = false;
      bool @_121_writeToDest = false;
      bool _rhs4 = true;
      bool _rhs3 = _rhs4;
      bool _rhs6 = true;
      bool _rhs5 = _rhs6;
      @_120_readFromSource = _rhs3;
      @_121_writeToDest = _rhs5;
      while ((@_116_file__offset) < (new BigInteger(@_115_len)))
      {
        BigInteger @_122_num__bytes = BigInteger.Zero;
        BigInteger _rhs7 = @_117_buffer__size;
        @_122_num__bytes = _rhs7;
        if (((@_116_file__offset) + (@_117_buffer__size)) >= (new BigInteger(@_115_len)))
        {
          BigInteger _rhs8 = (new BigInteger(@_115_len)) - (@_116_file__offset);
          @_122_num__bytes = _rhs8;
        }
        { }
        bool _out12;
        (@_111_sourceFileStream).@Read((int)(@_116_file__offset), @_118_buffer, (int)(@_119_start), (int)(@_122_num__bytes), out _out12);
        @_120_readFromSource = _out12;
        if (!(@_120_readFromSource))
        {
          System.Console.Write(Dafny.Sequence<char>.FromString("Read failed!\r\n"));
          return;
        }
        bool _out13;
        (@_113_destFileStream).@Write((int)(@_116_file__offset), @_118_buffer, (int)(@_119_start), (int)(@_122_num__bytes), out _out13);
        @_121_writeToDest = _out13;
        if (!(@_121_writeToDest))
        {
          System.Console.Write(Dafny.Sequence<char>.FromString("Write failed!\r\n"));
          return;
        }
        BigInteger _rhs9 = (@_116_file__offset) + (@_117_buffer__size);
        @_116_file__offset = _rhs9;
      }
      System.Console.Write(Dafny.Sequence<char>.FromString("File copied with Success!\r\n"));
    }
  }
